...
@section('title', 'Suppliers | Admin Dashboard | LMIS')
@section('content')
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span
                                            class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Supplier</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                                ...
                                <tr class="odd:bg-white even:bg-gray-50 border-b">
                                    ...
                                    <td class="px-6 py-4 flex gap-2">
                                        ...
                                        <button data-id="{{ $supplier->id }}"
                                            class="delete-supplier-btn px-3 py-2 text-xs text-white bg-red-600 rounded-lg hover:bg-red-700">
                                            Delete
                                        </button>
