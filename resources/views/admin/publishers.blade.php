                                ...
                                <tr class="odd:bg-white even:bg-gray-50 border-b">
                                    ...
                                    <td class="px-6 py-4 flex gap-2">
                                        ...
                                        <button data-id="{{ $publisher->id }}"
                                            class="delete-publisher-btn px-3 py-2 text-xs text-white bg-red-600 rounded-lg hover:bg-red-700">
                                            Delete
                                        </button>
    ...
    button.addEventListener('click', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.getElementById(`delete-publisher-form-${publisherId}`).submit();
            }
        });
    });
});
