...
class BorrowController extends Controller
{
    ...
    public function return (Request $request, $id)
    {
        ...
        // Use return_date from form or default to now
        ...
        ActivityLog::create([
            'user_id'     => Auth::id(),
            'action'      => 'return',
            'description' => Auth::user()->name . " returned '{$borrow->book->title}' (Copy #{$borrow->bookCopy->copy_number})",
        ]);
    ...
    {
        // Make the copy available if it's associated
        ...
        ActivityLog::create([
            ...
            'description' => Auth::user()->name . " deleted borrow record for '{$borrow->book->title}' (Copy #" . ($borrow->bookCopy ? $borrow->bookCopy->copy_number : 'N/A') . ")",
        ]);
